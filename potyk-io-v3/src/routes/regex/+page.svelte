...
<Ul>
  ...
  <li>На все эти задачи есть более robust решения:
    <Ul class="ml-6">
      <li><A href="https://dateutil.readthedocs.io/en/stable/"><code>python-dateutil</code></A> — для парса дат</li>
      <li><A href="https://pypi.org/project/phonenumbers/"><code>phonenumbers</code></A> — для парса телефонов</li>
      <li><A href="https://github.com/JoshData/python-email-validator"><code>email-validator</code></A> — для парса почт
      </li>
      <li>Либы для парсинга также содержат типовые парсеры: так <A href="https://docs.pydantic.dev/latest/usage/types/"><code>pydantic</code></A>
...
<Ul class="">
  ...
  <li>
    ...
    <img class="ml-6 border rounded p-4 m-2" src={IdeaRegex}>
  </li>
