  ...
  <Ul>
    ...
    <li>На все эти задачи есть более robust решения:
      <Ul class="ml-6">
        ...
        <li><A href="https://github.com/JoshData/python-email-validator"><code>email-validator</code></A> — для парса
          почт
        </li>
        <li>Либы для парсинга также содержат типовые парсеры: так <A
