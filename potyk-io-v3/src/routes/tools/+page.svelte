<script lang="ts">
	...
	const sections: { section: string; cards: (GotyCardData & { tags: Tag[] })[] }[] = [
		...
		},
		{
			...
			cards: [
				...
				},
				{
					to: 'https://miro.com/',
					title: 'Miro',
					subtitle: 'Диаграмминг, вайтбординг похуже',
					tags: ['diagrams']
				},
				{
				...
				},
				{
					...
					title: 'Mermaid',
					subtitle: 'Диаграммы как код',
					tags: ['diagrams']
				},
				{
					to: 'https://excalidraw.com/',
					title: 'Excalidraw',
					subtitle: 'Hand-drawn рисовалка',
					tags: ['diagrams']
				}
			]
		},
		...
		},
		{
			...
			cards: [
				{
					to: 'https://symbl.cc/en/',
					title: 'SYMBL',
					subtitle: 'Все Unicode символы',
					icon: '(◕‿◕)',
					tags: ['text']
				},
				{
		...
		},
		{
			...
			cards: [
				...
				{
					to: 'https://www.phind.com/',
					title: 'phind',
					subtitle: 'AI-поиск для кода',
					imgIcon: Phind,
					tags: ['ai']
				}
			]
		...
		{
			section: 'Утилитки для разработки',
			cards: [
				{
		...
		{
			section: 'Подборки для разработки',
			cards: [
				{
		...
		},
		{
			...
			cards: [
				...
				{
					to: 'https://twitter.com/hasantoxr',
					title: 'Чел обозревает ai-тулзы',
					tags: ['ai'],
					faIcon: 'twitter'
				},
				{
	...
	function selectTag(tag: string) {
		selectedTag = selectedTag === tag ? null : (tag as Tag);
	}
</script>
...
<div class="flex gap-2 flex-wrap items-center">
	{#each Object.entries(tags) as [tag, tagStr]}
		<button
			class={`py-2 px-4 bg-blue-50 hover:bg-blue-100  text-semibold rounded-full ${
				selectedTag === tag ? ' border-blue-200 border-2' : ''
			}`}
			on:click={() => {
				selectTag(tag);
			}}
